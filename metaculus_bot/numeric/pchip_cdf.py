...
def build_cdf_value_grid(
    ...
    scorer buckets resolutions against. Offline pooling primitives that consume x-values
    (e.g., PIT calibration, Vincentization, CRPS) must build their grid here so a
    zero_point question's pooled CDF aligns with the scorer's buckets.
